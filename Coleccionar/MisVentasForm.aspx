<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedIn.Master" AutoEventWireup="true" CodeBehind="MisVentasForm.aspx.cs" Inherits="Coleccionar.MisVentasForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:Label ID="lblVentasPublicadas" runat="server" Text="Ventas Publicadas"></asp:Label>
        </div>
    </div>
    <div class="row">
        <div class="grillaPublicaciones">
            <asp:GridView ID="gvVentasPublicadas" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvVentasPublicadas_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField DataField="Precio" HeaderText="Precio" DataFormatString="$ {0:#,0}" />
