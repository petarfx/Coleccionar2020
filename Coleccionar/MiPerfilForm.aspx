<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedIn.Master" AutoEventWireup="true" CodeBehind="MiPerfilForm.aspx.cs" Inherits="Coleccionar.MiPerfilForm" %>
            ...
            <div class="panel panel-info sombreado">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <asp:Label ID="lblTitulo" runat="server" Text="Perfil"></asp:Label>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div id="div_txtAlias" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtAlias" class="form-control" placeholder="Ingrese el Alias" runat="server" ReadOnly="True"></asp:TextBox>
                    ...
                    <div id="div_txtEmail" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtEmail" ReadOnly="True" class="form-control" placeholder="Ingrese el Email" runat="server" MaxLength="15" TextMode="Email"></asp:TextBox>
                ...
                <div class="row form-group">
                    <div id="div_txtApellido" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtApellido" ReadOnly="True" class="form-control" placeholder="Ingrese el Apellido" runat="server"></asp:TextBox>
                    ...
                    <div id="div_txtNombre" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtNombre" ReadOnly="True" class="form-control" placeholder="Ingrese el Nombre" runat="server"></asp:TextBox>
                ...
                <div class="row form-group">
                    <div id="div_txtDni" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtDni" class="form-control" ReadOnly="True" placeholder="Ingrese el DNI" runat="server" MaxLength="8"></asp:TextBox>
                    ...
                    <div id="div_txtFecNac" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <input type="date" id="txtFecNac" class="form-control" runat="server" disabled="disabled" />
                ...
                <div class="row form-group">
                    <div id="div_txtCalle" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtCalle" class="form-control" Enabled="False" placeholder="Ingrese la Calle" runat="server"></asp:TextBox>
                    ...
                    <div id="div_txtCalleNumero" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtCalleNumero" class="form-control" Enabled="False" placeholder="Ingrese el Número de domicilio" runat="server" MaxLength="5"></asp:TextBox>
                ...
                <div class="row form-group">
                    <div id="div_txtPiso" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtPiso" class="form-control" Enabled="False" placeholder="Ingrese el Piso" runat="server" MaxLength="3"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div id="div_txtDepto" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtDepto" class="form-control" Enabled="False" placeholder="Ingrese el Departamento" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="div_ddlProvincia" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlProvincia" class="form-control" runat="server" OnSelectedIndexChanged="ddlProvincia_SelectedIndexChanged" AutoPostBack="True" Enabled="False"></asp:DropDownList>
                    ...
                    <div id="div_ddlLocalidad" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlLocalidad" class="form-control" runat="server" AutoPostBack="True" Enabled="False"></asp:DropDownList>
                ...
                <div class="row form-group">
                    <div id="div_txtTelefono" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtTelefono" class="form-control" Enabled="False" placeholder="Ingrese el telefono" runat="server" MaxLength="10"></asp:TextBox>
                        </div>
                    </div>
                    <div id="div_txtCelular" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtCelular" Enabled="False" class="form-control" placeholder="Ingrese el Celular" runat="server" MaxLength="10"></asp:TextBox>
                        </div>
                    </div>
                </div>

                <div id="div_contraseñas" class="row form-group" runat="server" visible="false">
                    <div id="div_txtContraseña" class="col-md-6" style="padding-top: 10px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtContraseña" Enabled="False" class="form-control" placeholder="Ingrese la Contraseña" runat="server" MaxLength="15" TextMode="Password" ToolTip="La contraseña debe contener hasta 15 dígitos"></asp:TextBox>
                    ...
                    <div id="div_txtContraseña2" class="col-md-6" style="padding-top: 10px; padding-bottom: 5px">
                        ...
                        <div class="controls col-md-8 ">
                            <asp:TextBox ID="txtContraseña2" Enabled="False" class="form-control" placeholder="Reingrese la Contraseña" runat="server" TextMode="Password" MaxLength="15"></asp:TextBox>
                ...
                <div class="form-group-12 col-lg-12 col-md-12 text-center">
                    <asp:Button ID="btnAceptar" Visible="false" runat="server" Text="Aceptar" class="btn btn-primary" CausesValidation="true" OnClick="btnAceptar_Click" />
                    <asp:Button ID="btnEditar" runat="server" Text="Editar" class="btn btn-success" CausesValidation="False" OnClick="btnEditar_Click" />
                    <asp:Button ID="btnCancelar" Visible="false" runat="server" Text="Cancelar" class="btn btn-primary" CausesValidation="False" OnClick="btnCancelar_Click" />
                </div>
