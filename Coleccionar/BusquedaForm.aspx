        ...
        <div class="col-lg-12 ">
            <div class="table-responsive">
                <div id="panelGrilla" class="grillaPublicaciones centrado" runat="server">
                    <asp:GridView ID="gvPublicaciones" CssClass="table table-striped table-bordered table-hover" runat="server" Style="margin: 0 auto; width: 100%" AutoGenerateColumns="False" OnRowDataBound="gvPublicaciones_RowDataBound" EmptyDataText="La búsqueda no arrojó ningún resultado.">
                        <Columns>
